...
const GetAllItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!items)
        return res.status(204).json({ message: "You dont have any item inserted", status: 204 });
...
const GetItemById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!id)
        return res.status(400).json({ message: "An unexpected error was occurred", status: 400 });
...
const UpdateItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const item = yield (0, service_1.FindItemById)(id);
    if (!item)
        return res.status(204).json({ message: "That Item not exist", status: 204 });
